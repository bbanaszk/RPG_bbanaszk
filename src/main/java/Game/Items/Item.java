...
/**
 * Interface that is common to all items that will be used in the game. Will be implemented by any item added to the game.
 *
...
public interface Item {
    ...
    /**
     * Sets the items rarity. Rarity can be "Common", "Uncommon", "Rare", "Epic", or "Legendary" and aligns with an items
     * tier (tier 1 is "Common" and tier 5 is "Legendary")
