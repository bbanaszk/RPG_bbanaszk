...
/**
 * Class for an item of type Boots that implements the Item interface.
 *
...
public class Boots implements Item {
    ...
    private final String itemType = "Boots";
    public int tier;
    public SpecialEffect specialEffect;

    /**
     * Constructor of the Boots Item. Automatically assigns tier based on rarity given.
     ...
     */
    public Boots(String itemName, int defenseValue, String rarity, SpecialEffect specialEffect) {
