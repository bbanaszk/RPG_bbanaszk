...
/**
 * Class for an item of type Gauntlet that implements the Item interface.
 *
...
public class Gauntlet implements Item {
    ...
    /**
     * Constructor of the Gauntlet Item. Automatically assigns tier based on rarity given.
