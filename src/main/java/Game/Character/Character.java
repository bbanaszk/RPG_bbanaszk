...
public interface Character {
	 ...
	 * @return loot as a List<Item>, where Item is a class created for various items that can be used by characters
	 */
	 ...
	 * @param loot as a List<Item>, where Item is a class created for various items that can be used by characters
	 */
